...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Extra Credit: https://blog.udemy.com/ruby-inject/
    # Describe in your own words what inject does.
    # The INJECT keyword in Ruby calls the INJECT method 
    # that is most commonly used with arrays, with the enumerable 
    # module and with converting array elements into hashes.
  end
